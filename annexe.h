...
#define vitesse_pi 15   //vitesse du pigeon pour le sous programme menu
#define couleur_max 255 //correspond à la couleur 255
...
///permet l'affichage du menu et permet l'interaction avec l'utilisateur
...
// -> il retourne 1 si on clique et 0 si on ne clique pasint draw_bouton(int posx, int posy, int pos2x, int pos2y, int color1, int color2, int profondeur, char* texte,FONT*font1);
