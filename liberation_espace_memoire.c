...
/***********************************************************************************************
********** ensemble de sous programme permettant la liberation de l'espace mémoire  ************
************************************************************************************************/
...
{
    /*****   4 liberation mémoire *******/

    printf("\n");
    free_tab_map(tab,info);
    //confirmation de la liberation par écrit dans le sous programme
...
// en paramètre l'adresse du tableau d'image  || le nombre d'image du tableau || le nom du tableau
